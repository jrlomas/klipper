...
# judgement: unknown, executable, and safety-affecting changes always confirm;
# explicit consequential allowlists auto-apply with undo + audit; cosmetic
# ones auto-apply. Everything is journaled and reversible. Built now
# (CPU-only, testable) so dropping a
...
__all__ = [
    "Change", "parse_config", "diff_configs", "apply_config_edits",
