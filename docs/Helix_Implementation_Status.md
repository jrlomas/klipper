...
* **ESP32:** the component/modem design has host/stub evidence, but has not
  had its first Xtensa toolchain build. The ESP32 guide also lists runtime
  work such as keepalive/reconnect, ISR bring-up, FEC enablement, reset and
  watchdog support, and RMT/FOC follow-ups.
