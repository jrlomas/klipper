...
Qwen3-4B workstation preflight are realized. CUDA/ROCm binaries compile for
both workstation adapters; GPU execution, live-machine apply, and Pi 5 +
Hailo-10H validation remain. The roadmap that got
