...
During this guide, it may be necessary to make changes to the Helix
...
command in the terminal box. This command requests Helix to go into a
...
in the Helix configuration file. Be sure to read the
[bed leveling](Bed_Level.md) guide. Also see the [Slicers](Slicers.md)
document for information on configuring a slicer with Helix.
